    ...
    IOptions<EmailSenderSettings> options) : BackgroundService
{
    ...
    private async Task ProcessSingleMessageAsync(SendedMailMessage message, CancellationToken cancellationToken)
    {
    ...
    private async Task HandleRetryAsync(SendedMailMessage message, Exception exception)
    {
