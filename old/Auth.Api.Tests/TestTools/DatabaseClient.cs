using Auth.ApiClient;
using Auth.Data;

namespace Auth.Api.Tests.TestTools;

public class DatabaseClient(Func<ApplicationDbContext> createWebDbContext, AuthClient apiClient)
{
    ...
    public AuthClient ApiClient { get; } = apiClient;
